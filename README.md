...
| Nguồn giá thống nhất | Mọi nơi hiển thị giá (trang mã, danh sách mã, danh mục, khớp lệnh ảo) đều đi qua `services/pricing.py`: **ưu tiên giá khớp trong phiên**, chỉ lùi về giá đóng cửa khi hôm nay chưa có giá khớp nào. Giá khớp được chấp nhận theo NGÀY giao dịch chứ không theo số phút — job poll chạy GitHub Actions gói miễn phí hay trễ nhịp, ngưỡng phút sẽ vứt mất giá vừa lấy được. Danh sách mã lấy giá hàng loạt (2 truy vấn cho cả trăm mã) |
